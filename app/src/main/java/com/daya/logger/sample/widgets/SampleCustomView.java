...
public class SampleCustomView extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = getContext().obtainStyledAttributes(
                attrs, R.styleable.SampleCustomView, defStyle, 0);

        mExampleString = a.getString(
                R.styleable.SampleCustomView_exampleString);
        mExampleColor = a.getColor(
                R.styleable.SampleCustomView_exampleColor,
                mExampleColor);
        // Use getDimensionPixelSize or getDimensionPixelOffset when dealing with
        // values that should fall on pixel boundaries.
        mExampleDimension = a.getDimension(
                R.styleable.SampleCustomView_exampleDimension,
                mExampleDimension);

        if (a.hasValue(R.styleable.SampleCustomView_exampleDrawable)) {
            mExampleDrawable = a.getDrawable(
                    R.styleable.SampleCustomView_exampleDrawable);
